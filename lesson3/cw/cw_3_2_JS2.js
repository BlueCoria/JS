...
let simpsons = [
    ...
    },
    {
        ...
        info: 'Ма́ргарет Эвелин «Мэ́гги» Си́мпсон (англ. Margaret Evelyn “Maggie” Simpson) — персонаж мультсериала ' +
            '«Симпсоны». Впервые появилась на телевидении в шоу Трейси Ульман, в короткометражке Good Night (англ.)' +
            'русск. 19 апреля 1987 года. Мэгги была придумана и разработана карикатуристом Мэттом Грейнингом, пока он ' +
            'ждал встречи с Джеймсом Л. Бруксом. Названа в честь младшей сестры Грейнинга. После появления в шоу Трейси' +
            ' Ульман, через три года семья Симпсонов получила собственный сериал на телеканале Fox, дебют произошёл 17 ' +
            'декабря 1989 года.',
...
for (let i = 0; i < simpsons.length; i++) {
    let simpson = simpsons[i]
        document.write(`<div class="simpsons-box">
                                        <div class="sp-title">
                                            <h2>Name - ${simpson.name}</h2>
                                            <h2>Surname - ${simpson.surname}</h2>
...
//                 </div>
//                 <div class="sp-info"><p>${simpson.info}</p></div>
//                 <div class="sp-img"><img src="${simpson.photo}" alt="${simpson.name}_${simpson.surname}"></div>
//     </div>`)
// }
// document.write(`</div>`)